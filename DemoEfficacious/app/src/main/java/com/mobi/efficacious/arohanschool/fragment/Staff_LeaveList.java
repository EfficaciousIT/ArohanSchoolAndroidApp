...
import com.mobi.efficacious.arohanschool.adapters.StaffLeaveListAdapter;
...
public class Staff_LeaveList extends Fragment {
    View myview;
    ...
    StaffLeaveListAdapter madapter;
    ...
    public void generateLeaveList(ArrayList<LeaveDetail> taskListDataList) {
        try {
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                madapter = new StaffLeaveListAdapter(taskListDataList,getActivity());
