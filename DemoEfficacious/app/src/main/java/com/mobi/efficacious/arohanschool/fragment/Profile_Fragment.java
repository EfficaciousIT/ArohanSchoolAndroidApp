...
import com.mobi.efficacious.arohanschool.MultiImages.activities.Single_image;
...
import com.mobi.efficacious.arohanschool.entity.ProfileDetail;
...
//            Observable<ProfileDetailsPojo> call = service.getProfiledetails("GetStudentProfile","1", "1", "1");
    ...
    public void generateProfileList(ArrayList<ProfileDetail> taskListDataList) {
        try {
            Log.d("generateProfileList", "generateProfileList_Log" + taskListDataList.toString());
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                String data = taskListDataList.toString();
