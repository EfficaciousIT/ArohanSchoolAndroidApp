...
public class TeacherLeaveListAdapter extends RecyclerView.Adapter<TeacherLeaveListAdapter.LeaveHolder> {

    private ArrayList<LeaveDetail> itemsArrayList;
    private Context mcontext;

    String LeaveApplication_id;
    public TeacherLeaveListAdapter(ArrayList<LeaveDetail> dataList,Context context) {
