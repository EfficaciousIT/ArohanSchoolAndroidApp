package com.mobi.efficacious.arohanschool.MultiImages.adapters;
...
public class CustomImageSelectAdapter extends CustomGenericAdapter<Image> {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        String tp=arrayList.get(position).path;
        Glide.with(context)
                .load(arrayList.get(position).path)
                .placeholder(R.mipmap.profile).into(viewHolder.imageView);
