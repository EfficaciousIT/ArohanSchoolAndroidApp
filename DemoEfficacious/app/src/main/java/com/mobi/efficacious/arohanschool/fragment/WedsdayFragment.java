...
public class WedsdayFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mrecyclerView = (RecyclerView) getActivity().findViewById(R.id.wedsday_list);
    ...
    public void  wedAsync (){
        try {
            DataService service = RetrofitInstance.getRetrofitInstance().create(DataService.class);
            mCompositeDisposable.add(service.getTimeTableDetails("selectStudentTT",school_id,"wednesday",Academic_id,Std_id,"")
