...
public class FridayFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        mrecyclerView = (RecyclerView) getActivity().findViewById(R.id.friday_list);
    ...
    public void  friAsync (){
        try {
            DataService service = RetrofitInstance.getRetrofitInstance().create(DataService.class);
            mCompositeDisposable.add(service.getTimeTableDetails("selectStudentTT",school_id,"friday",Academic_id,Std_id,"")
