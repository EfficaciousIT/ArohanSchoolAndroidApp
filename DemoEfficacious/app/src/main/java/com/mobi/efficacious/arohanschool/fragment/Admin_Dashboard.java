...
import com.mobi.efficacious.arohanschool.adapters.NoticeBoardAdapter;
import com.mobi.efficacious.arohanschool.adapters.StudentListAdapter;
import com.mobi.efficacious.arohanschool.common.ConnectionDetector;
import com.mobi.efficacious.arohanschool.entity.DashboardDetail;
import com.mobi.efficacious.arohanschool.entity.DashboardDetailsPojo;
import com.mobi.efficacious.arohanschool.entity.Holiday;
...
//                 date_selected= String.valueOf(day1)+("/")+ String.valueOf(month1)+("/")+ String.valueOf(calendar.get(Calendar.YEAR));
    ...
    public void studentAsync() {
        try {
            ...
            mCompositeDisposable.add(service.getDashboardDetails("StudentCountByPrincipal", "3")
    ...
    public void generateStudentCount(ArrayList<DashboardDetail> taskListDataList) {
        Toast.makeText(getContext(), "Student Count" + taskListDataList.get(1).getPresent(), Toast.LENGTH_LONG).show();
        try {
    ...
    public void FCMTOKENASYNC(String command, String Firebasetoken, String EMail) {
        try {
            DataService service = RetrofitInstance.getRetrofitInstance().create(DataService.class);
            LoginDetail loginDetail = new LoginDetail(Firebasetoken, EMail, User_id,Schooli_id,academic_id);
