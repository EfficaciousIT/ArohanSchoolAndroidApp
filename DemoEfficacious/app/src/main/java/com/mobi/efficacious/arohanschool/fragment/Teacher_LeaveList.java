...
import com.mobi.efficacious.arohanschool.adapters.TeacherLeaveListAdapter;
...
public class Teacher_LeaveList extends Fragment {
   View myview;
   ...
   TeacherLeaveListAdapter madapter;
   ...
   public void  AdminAsync (){
      try {
         ...
         if (UserType_id.contentEquals("6") || UserType_id.contentEquals("7")) {
            command="SelectTeacherLeaveListBYPrincipal";
         } else {
            command="SelectTeacherLeaveList";
         }
   ...
   public void generateLeaveList(ArrayList<LeaveDetail> taskListDataList) {
      try {
         if ((taskListDataList != null && !taskListDataList.isEmpty())) {
            madapter = new TeacherLeaveListAdapter(taskListDataList,getActivity());
