...
import com.mobi.efficacious.arohanschool.adapters.ChatAllUser_Adapter;
...
public class Staff_Chat_Fragment extends Fragment {
    View myview;
    ...
    public void ChatAllTeacherAsync (){
        try {
            ...
            Observable<ChatDetailsPojo> call = service.getChatUserDetails("selectstaff",Schooli_id,"",Standard_id,Division_id,Academic_id);
