...
import com.mobi.efficacious.arohanschool.adapters.StaffApprovalAdapter;
...
public class StaffApprovalFragment extends Fragment {
    View myview;
    ...
    public void generateLeaveList(ArrayList<LeaveDetail> taskListDataList) {
        try {
            if ((taskListDataList != null && !taskListDataList.isEmpty())) {
                madapter = new StaffApprovalAdapter(taskListDataList,getActivity());
